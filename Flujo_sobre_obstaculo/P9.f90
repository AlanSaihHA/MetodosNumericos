...
ALLOCATE(mark_cells(nx,ny), pt(np,2))
...
P=0.0
u(:,1:ny)=1.0 !velocidad de entrada    ¿Por qué todo el dominio?
u(:,ny+1)=0.0; u(:,0)=0.0
u1=u; v1=v
d_h=0.0
d_v=0.0

x0_obs=1.5; xl_obs=2.5; y0_obs=-0.35; yl_obs=0.35 !localización del obstáculo
mark_cells=0.0
...
!::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    DO i=1, nx
      ...
      END DO
    END DO
      u1(nx,:)=u1(nx-1,:)    !corrección de la frontera Neumann este, estetica
      v1(nx+1,:)=v1(nx,:)    !corrección de la frontera Neumann este, estetica
...
DO i=1,10*ny_obs
  n=n+1
  pt(n,1)=xp0
  pt(n,2)=ym-dy*FLOAT(i-1)/10    !¿Qué proposito tiene este si el segundo remplaza a pt?
END DO
DO i=1,10*ny_obs
  n=n+1
  pt(n,1)=xp0
