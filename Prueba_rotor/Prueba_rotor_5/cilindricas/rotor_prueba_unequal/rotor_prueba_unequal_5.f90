        ...
        do j=bj,ej
           do i=bi,ei
              ...
              IF ((mark_cells(i,j) .EQ. 1)) THEN   !IF ((mark_cells(i,j) .EQ. 1) .or. (mark_cells3(i,j) .EQ. 1)) THEN
              		call source(u0,u(i_obs,j),rho,Area,r,dx,dv,xcc,xc(i),Sp_f)
              		!call source(u0,u,rho,Area,r,dx,dv,xcc,xc,Sp_f)
...
!:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
Subroutine source(u0,u,rho,Area,r,dx,dv,xcc,xc,Sp_f)
implicit none
