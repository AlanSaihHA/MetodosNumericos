Program rotor_prueba
  ...
  ny=100
  y0=0.0
  yl=7.*r           !El ancho del dominio es 2 veces el radio
...
x0_obs=0.; xl_obs=3.*r+(xm2-xm1)/nxm; y0_obs=0.; yl_obs=r !localización del obstáculo, el rotor se coloca a 3 radios de la entrada
mark_cells=0.0
        ...
        do i=bi,ei
           do j=bj,ej
              ...
              IF ((mark_cells(i,j) .EQ. 1)) THEN   !IF ((mark_cells(i,j) .EQ. 1) .or. (mark_cells3(i,j) .EQ. 1)) THEN
              		call source(u0,u(i_obs,j),rho,Area,r,dx,dv,xcc,xc(i),yc(y_obs),yc(j),Sp_f)
...
!:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
Subroutine source(u0,u,rho,Area,r,dx,dv,xcc,xc,ycc,yc,Sp_f)
implicit none
